...
const AvatarSelectionView: React.FC<AvatarSelectionViewProps> = ({ onSelect }) => {
  // Memoize the selection logic to ensure it doesn't change on re-renders unless component remounts
  const selectedAssistants = useMemo(() => {
    // Get a random human assistant
    ...
    // Dog Selection Logic:
    // 1. Separate Kotetsu (Rare) from Regular dogs
    ...
    // 2. Determine if Rare or Regular (20% chance for Kotetsu if he exists)
